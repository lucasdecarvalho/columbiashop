      ...
      >
        <div className="mb-8 flex flex-col items-center">
          ...
          <h1 className="mt-4 text-2xl font-bold text-white">
            Columbia<span className="text-brand-400">Shop</span>
          </h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2.5 text-sm text-white placeholder-slate-500 outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20"
                {...register('email')}
              />
            ...
            <Button type="submit" size="lg" className="mt-2 w-full bg-brand-600 hover:bg-brand-700">
              Entrar no painel
            </Button>
          </form>
